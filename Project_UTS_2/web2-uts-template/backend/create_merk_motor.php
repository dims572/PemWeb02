...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3">Buat Merk</a>
            <!-- Sidebar Toggle-->
            ...
            <div id="layoutSidenav_nav">
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            <a class="nav-link" href="merk_motor.php">
                ...
                <div class="card-body">
                                <form method="POST" action="proses_merk_motor.php">
                                    <div class="form-group">
                                        <label for="nama_merk" class="form-label">Merk Motor</label>
                                        <input id="nama_merk" name="nama_merk" type="text" class="form-control" required>
                                    </div>
                                    <div class="form-group mt-4">
                                        <input type="submit" name="proses" type="submit" class="btn btn-success form-control" value="Simpan" />
                                    </div>
                                </form>
                            </div>
                </main>
