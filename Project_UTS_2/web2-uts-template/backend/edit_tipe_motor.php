...
<body class="sb-nav-fixed">
    <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
        <!-- Navbar Brand-->
        <a class="navbar-brand ps-3">Edit Tipe</a>
        <!-- Sidebar Toggle-->
    ...
    <div id="layoutSidenav">
        <div id="layoutSidenav_nav">
            <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                <div class="sb-sidenav-menu">
                    <div class="nav">
                        <a class="nav-link" href="tipe_motor.php">
        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="card-body">
                    <form method="POST" action="proses_tipe_motor.php">
                        ...
                        <div class="form-group">
                            ...
                            <input id="tipe_motor" name="tipe_motor" type="text" class="form-control" required
                                value="<?= $result['tipe_motor'] ?>">
                        </div>
                        <div class="form-group mt-4">
                            <input type="submit" name="proses" type="submit" class="btn btn-success form-control"
                                value="Update" />
                        </div>
                    </form>
                </div>
